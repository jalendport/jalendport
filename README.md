...
- <a href="https://github.com/jalendport/craft-metronome"><img src="icons/craft-metronome.svg" width="20" height="28" align="middle" alt=""></a> [`craft-metronome`](https://github.com/jalendport/craft-metronome) — Laravel-style task scheduling for Craft CMS: one crontab entry, everything else in PHP
...
- plus [a few more](https://github.com/jalendport?tab=repositories&q=craft-)
...
**Odds & ends** — Everything that doesn't fit neatly above.
- [`tailwindcss-fluid`](https://github.com/jalendport/tailwindcss-fluid) — fluid `clamp()` utilities and range variants for Tailwind CSS v4
- [`dotfiles`](https://github.com/jalendport/dotfiles) — my personal collection of dotfiles
